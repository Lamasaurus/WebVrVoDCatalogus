...
function setupScene(existing_scene) {
...
function animate() {
    ...
    //Stop animation loop when not in VR mode
    if (HTML2VR.inVR) vrDisplay.requestAnimationFrame(animate);
}
        ...
        value: function startVR() {
            if (!vrMode) {
                ...
                if (vrDisplay) {
                    ...
                    //Start animation when in VR mode
