...
THREE.CSS3DObject = function ( element ) {
	...
	this.original_element = element.cloneNode(true);
...
THREE.CSS3DStereoRenderer = function () {
	...
	this.render_left = true;

	this.setClearColor = function () {

	};

  // mikestaub - the following 4 functions are WebGL specific, but
  // VREffect.js is expecting them. I will define them here for now.
  ...
  this.getSize = function() {
	...
	this.render = function ( scene, camera ) {
		...
		if(this.render_left){
			...
			renderObject( scene, camera, cameraElementL, 'L' );
			...
			renderObject( scene, camera, cameraElementR, 'R' );

		}

		this.render_left = !this.render_left;
	};
